let tiempoRestante = 10;
        ...
        function actualizarCuentaRegresiva() {
            if (tiempoRestante > 0) {
                ...
                document.querySelector(".cuenta-regresiva").innerHTML = "<h4>¡Felices 50 Años Vane!</h4><br><h4>¡Te deseamos lo mejor en este día tan especial!</h4>";
            }
        }
        ...
        musicIcon.addEventListener("click", function () {
            if (music.paused) {
                music.play();
                musicIcon.style.color = "var(--color-cuarto)";
                musicIcon.style.border = "3px solid var(--color-cuarto)";
            } else {
                music.pause();
                music.currentTime = 0;
